...
namespace w
{
    namespace graphics
    {
        ...
        void Renderer::draw(FrameBuffer const& frameBuffer, MeshAsset const& mesh, ShaderProgramAsset const& shaderProgram)
        {
            private_->draw(frameBuffer, mesh, shaderProgram);
        }
